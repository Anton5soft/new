...
(function($) {
    ...
    $.fn.lightBox = function(settings) {
        ...
        settings = jQuery.extend({
            ...
            imageLoading:			'/site/jssliderimage/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
            imageBtnPrev:			'/site/jssliderimage/images/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
            imageBtnNext:			'/site/jssliderimage/images/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
            imageBtnClose:			'/site/jssliderimage/images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
            imageBlank:				'/site/jssliderimage/images/images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
